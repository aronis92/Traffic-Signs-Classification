...
class LeNet:
    ...
    def __init__(self, n_out=43, mu=0, sigma=0.1, learning_rate=0.001):
        ...
        #Convolutional Layer 1: Input = 32x32x3. Output = 30x30x6.
        ...
        #Convolutional Layer 2: Input = 15x15x6. Output = 12x12x16.
        ...
        #Flattening: Input = 6x6x16. Output = 576.
        self.fully_connected0 = flatten(self.conv2)
        
        #Fully Connected Layer 1: Input = 576. Output = 120.
        self.connected1_weights = tf.Variable(tf.truncated_normal(shape=(576, 120), mean = self.mu, stddev = self.sigma))
